<?php
    ...
    if(isset($_POST['submitacc'])){
        ...
        $pass = $_POST["pass"];
        $conf = $_POST["conf"];
        mysqli_query($db, "UPDATE akun SET account = 'null' WHERE ID='$id'");
        ...
        if(mysqli_num_rows($user) > 0){
            echo "<script>
                ...
                mysqli_query($db, "UPDATE akun SET account = $email WHERE ID='$id'");
...
<body id="beranda">
	...
	<form method="POST" action="" enctype="multipart/form-data">	
        <div class="container">
            ...
            <div class="row">
                <div class="col-10">
                    <label for="url">Password Baru:</label>
                </div>
                <div class="col-90">
            ...
            <div class="row">
                <div class="col-10">
                    <label for="url">Konfirmasi Password:</label>
                </div>
                <div class="col-90">
